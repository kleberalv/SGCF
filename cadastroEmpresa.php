          ...
          <div class="card-body">
              ...
              <div class="form-group">
                    <?php if(!empty($resultado['id'])){
                        print'<center><h3>Alterar cadastro de Empresas</h3></center>';
                        }else{
                            print'<center><h3>Cadastro de Empresas</h3></center>';
                        } ?>
                </div>
            <br>
                ...
                <div class="form-group">
                    ...
                    <label class="col-md-10 control-label">Nome da empresa</label>
                        <div class="col-md-10 inputGroupContainer">
                            ...
                            <?php if(!empty($resultado['nome'])){
                                print '<input id="nome" name="nome" placeholder="Nome da empresa" class="form-control" required="true" value="'.$resultado['nome'].'" type="text">';
                                    }else{
                                    print '<input id="nome" name="nome" placeholder="Nome da empresa" class="form-control" required="true" value="" type="text">';
                                    }?>
                            </div>
                        </div>

<br>
                        <label class="col-md-10 control-label">CNPJ</label>
                        <div class="col-md-10 inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon">
                                ...
                                <?php if(!empty($resultado['usuario'])){
                                    print '<input id="usuario" name="cnpj" placeholder="CNPJ" class="form-control" required="true" value="'.$resultado['usuario'].'" type="text">';
                                }else{
                                    print '<input id="usuario" name="cnpj" placeholder="CNPJ" class="form-control" required="true" value="" type="text"> ';
                                }?>
                            </div>
                        </div>
 <br>                           
