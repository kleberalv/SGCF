    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="dropdown">
         ...
         <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="principal.php?menu=3">Listagem de veículo<span class="caret"></span></a>
          <ul class="dropdown-menu">
             <li><a href="#" target="_blank">#</a></li>
          </ul>
        </li>
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="principal.php?menu=2">Cadastrar Veículo<span class="caret"></span></a>
          <ul class="dropdown-menu">
          </ul>
        </li>
        <li class="dropdown">
